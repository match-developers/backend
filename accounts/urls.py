...
from .views import RegisterView, LoginView, SocialLoginView, PasswordResetView, UserProfileNewsfeedView, EditUserProfileView, FollowUserView, UserStatisticsView, PlaystyleTestView
